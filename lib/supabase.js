...
// Don't throw error at module load - let the handler check and return proper error
// This allows the function to start and return a proper HTTP error response
if (!supabaseUrl || !supabaseKey) {
  console.warn('⚠️  Missing Supabase environment variables (will be checked in handler)');
